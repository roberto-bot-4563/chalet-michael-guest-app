...
import {
  House, MapPin, Wifi, Clock3, Car, Bus, Flame, Heater, Trash2, Coffee,
...
const TEXT = {
  de: {
    ...
    windows: "2. Fenster & Läden öffnen", windowsIntro: "Bitte vorsichtig vorgehen - die Fenster sind älter und teilweise schwergängig.",
    windowSteps: [
    ...
    water: "Hauptwasser öffnen", waterSteps: [
      ["Schritt 1 - Schlüssel holen", "Im Keller das Schlüsselkästchen mit Code 391 öffnen und den Schlüssel für den Aufbewahrungs- und Boilerraum entnehmen.", "Code: 391"],
      ["Schritt 2 - Boilerraum öffnen", "Mit dem Schlüssel den Boilerraum öffnen.", ""],
  ...
  en: {
    ...
    windows: "2. Open windows & shutters", windowsIntro: "Please take care - the older windows can be stiff.",
    windowSteps: [
    ...
    water: "Open the main water supply", waterSteps: [
      ["Step 1 - Get the key", "Open the basement key box with code 391 and take the key for the storage and boiler room.", "Code: 391"],
      ["Step 2 - Open the boiler room", "Use the key to open the boiler room.", ""],
    ...
    kitchen: "Kitchen", kitchenText: "A Nespresso machine with a separate milk frother and a filter coffee machine are available.",
  ...
  fr: {
    ...
    windows: "2. Ouvrir les fenêtres & volets", windowsIntro: "Attention - les anciennes fenêtres peuvent être difficiles à ouvrir.",
    windowSteps: [
    ...
    water: "Ouvrir l'eau principale", waterSteps: [
      ["Étape 1 - Prendre la clé", "Ouvrez le boîtier à clés du sous-sol avec le code 391 et prenez la clé du local de rangement et de la chaufferie.", "Code: 391"],
      ["Étape 2 - Ouvrir la chaufferie", "Utilisez la clé pour ouvrir le local.", ""],
